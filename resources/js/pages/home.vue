            ...
            <div class="flex flex-row p-4 bg-gray-200 rounded">
              <div class="px-2">
                <router-link to="/filme">
                  <img
                    src="img/video/poster/avengers.jpg"
                    class="rounded"
                  >
                </router-link>
              </div>
              ...
              <div class="px-2">
                <router-link to="/filme">
                  <img
                    src="img/video/poster/shutterisland.jpg"
                    class="rounded"
                  >
                </router-link>
              </div>
              ...
              <div class="px-2">
                <router-link to="/filme">
                  <img
                    src="img/video/poster/fightclub.jpg"
                    class="rounded"
                  >
                </router-link>
              </div>
              ...
              <div class="px-2">
                <router-link to="/filme">
                  <img
                    src="img/video/poster/diehard.jpg"
                    class="rounded"
                  >
                </router-link>
              </div>
          ...
          <div class="flex flex-col">
            ...
            <div class="flex flex-row bg-gray-200 w-full p-4 my-2 rounded">
              <div class="">
                ...
                >
                  ThePaparranas
                </router-link> comentou em <router-link
                  to="/filme"
                  class="red-link"
                >
                  Game Of Thrones S6-E8
