...
$(document).ready(function () {
  ...
  $(pageClass).find('.top-menu').find('li').find('a').css({
    color: '#fff',
...
$(window).scroll(function () {
  ...
  if (scroll >= 55) {
    ...
    $(menuClass).find('.menu-left').find('li').find('a').css({
      color: '#666',
      textShadow: 'none'
    });
    $(menuClass).find('.menu-left').find('li').find('a').mouseover(function () {
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\mov\resources\js\nav.js */"./resources/js/nav.js");
